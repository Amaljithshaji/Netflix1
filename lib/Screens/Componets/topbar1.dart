...
class Top_Bar1 extends StatefulWidget {
  
  const Top_Bar1({super.key});

  @override
  State<Top_Bar1> createState() => _Top_Bar1State();
}

class _Top_Bar1State extends State<Top_Bar1> {
                                ...
                                child: DropdownButton(
                                  ...
                                  DropdownMenuItem<String>(
                                    child: GestureDetector(onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (context)=>Home())),
                                     ...
                                     DropdownMenuItem<String>(
                                    child: GestureDetector(onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (context)=>TvShows())),
                                      child: Text('Tv Shows',
                                      style: TextStyle(fontSize: 20,color: Colors.white),),
                                    ), value:'Tv Shows'),
                                     DropdownMenuItem<String>(
                                    child: GestureDetector(onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (context)=>Movies())),
                                      child: Text('Movies',
                                      style: TextStyle(fontSize: 20,color: Colors.white),),
                                    ), value:'Movies'),
                                     DropdownMenuItem<String>(
